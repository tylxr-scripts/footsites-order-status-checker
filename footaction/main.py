...
def checkOrder(orderNum, customerNum, importantCookie):
    ...
    s = session.get('https://www.footaction.com/api/session', headers=sessionHeaders, cookies=cookies)
    ...
    checkReq = session.post('https://www.footaction.com/api/users/orders/status', headers=headers, json=payload, cookies=cookies)
