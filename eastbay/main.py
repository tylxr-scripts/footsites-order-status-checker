...
def checkOrder(orderNum, customerNum, importantCookie):
    ...
    s = session.get('https://www.eastbay.com/api/session', headers=sessionHeaders, cookies=cookies)
    ...
    checkReq = session.post('https://www.eastbay.com/api/users/orders/status', headers=headers, json=payload, cookies=cookies)
